...
public class UserRoleBO extends BaseBO {
	...
	public void createUserRole(RegisterVO userVO) throws SQLException, Exception{
		//log.debugPrintCurrentMethodName();
	...
	public List getProductDetails(ProductVO productVO)throws SQLException, Exception{
		System.out.println("enter into BO to pass the all product details");
		try{
			UserDAO userDAO =   new UserDAO(getConnection());
			return userDAO.getProductDetails(productVO);
