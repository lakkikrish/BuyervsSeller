...
public class DateUtil {
	...
	public static String changeDateFormat(String strDate, final String currentDateFormat, final String newDateFormat) {
		...
		try {
			...
			System.out.printf(" Exception in changeDateFormat " + e.getMessage(), e);
		}
...
*/
	...
	public static final Date formatString(String dateInStr, int formatCode) {
		...
		try {
			...
			System.out.printf("Exception in formatString" + e.getMessage(), e);
		}
		return strdt;
	}
	...
	public static final Date formatAppointmentDate(String dateInStr) {
		...
		try {
			...
			System.out.printf("Exception in formatAppointmentDate" + e.getMessage(), e);
		}
		return strdt;
	}
	...
	public static long getDateDiffInDays(String fromDateStr, String toDateStr) {
		...
		try {
			...
			System.out.printf("Exception in getDateDiffInDays" + e.getMessage(), e);
		}
		return daysDiff;
	}
	...
	public static final String calcDateFromJulian(int daynumber) {
		...
		try {
			...
			System.out.printf("IllegalArgumentException in calcDateFromJulian" + e.getMessage(), e);
		} catch (Exception e) {
			System.out.printf("Exception in calcDateFromJulian" + e.getMessage(), e);
		}
...
*/
	...
	public static Long getDaysBetweenDates(String dateFormat, String inputDate1, String inputDate2) {
		...
		try {
			...
			System.out.printf("Exception in getDaysBetweenDates " + e.getMessage(), e);
		}
		return numDays;
	}
	...
	public static Long getHoursDiff(String d1, String d2, String dateFormate) {
		...
		try {
			...
			System.out.printf("Exception in getHoursDiff " + e.getMessage(), e);
		}
...
/*	public static boolean isFutureDate(String date) {
		...
		try {
			...
			System.out.printf("ParseException in isFutureDate" + e.getMessage(), e);
			return false;
		}
